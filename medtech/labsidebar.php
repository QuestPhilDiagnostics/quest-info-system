...
<nav class="navbar navbar-toggleable-md navbar-dark navbar-custom">
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    <div class="navbar-nav">
      ...
      <a class="nav-item nav-link" href="LABSummary.php"><i class="fas fa-flask"></i>&nbsp;Lab Summary</a>
      <a class="nav-item nav-link" href="LabSections.php"><i class="fas fa-users"></i>&nbsp;Laboratory Sections</a>
      <a class="nav-item nav-link" href="ResSections.php"><i class="fas fa-th-list"></i>&nbsp;Result Sections</a>
